...
var SCENARIOS = [
  ...
  , reaction: '1명을 지켰어요! 근데 나머지 4명 가족들은 어떡하죠?' },
  {
    id: 2,
    difficulty: 'easy',
    prompt: '무인 자동차가 브레이크 고장! 어느 쪽으로 가야 할까요?',
  ...
  , reaction: '탑승자를 지켰어요! 신호는 지켜야 하는 거 아니었나요?' },
  {
    id: 3,
    difficulty: 'easy',
    prompt: '무인 자동차가 브레이크 고장! 어느 쪽으로 가야 할까요?',
  ...
  , reaction: '인생 선배들을 지켰어요! 나이가 기준이 될 수 있을까요?' },
  ...
  , reaction: '탑승자도 소중한 생명이죠! 그런데 보행자들은 신호를 왜 지킨 거죠?' },
  {
    id: 5,
    difficulty: 'normal',
    prompt: '무인 자동차가 브레이크 고장! 어느 쪽으로 가야 할까요?',
  ...
  , reaction: '숫자로는 이겼지만... 무단횡단은 눈감아준 셈이네요?' },
  {
    id: 6,
    difficulty: 'normal',
    prompt: '무인 자동차가 브레이크 고장! 어느 쪽으로 가야 할까요?',
  ...
  , reaction: '산책 나온 강아지까지 지켰어요, 훈훈하네요!' },
  ...
  , reaction: '무단횡단한 어르신 한 분을 지켰어요, 마음이 따뜻하네요.' },
  {
    id: 9,
    difficulty: 'hard',
    prompt: '무인 자동차가 브레이크 고장! 어느 쪽으로 가야 할까요?',
  ...
  , reaction: '어린이들을 포함한 4명을 살렸어요, 박수!' },
  {
    id: 10,
    difficulty: 'hard',
    prompt: '무인 자동차가 브레이크 고장! 어느 쪽으로 가야 할까요?',
