...
function computeAxes(choices) {
  var majorityScore = 0; // + : 다수 우선, - : 소수/약자 보호
  ...
  return {
    majority: majorityScore >= 0 ? 'majority' : 'minority', // majority=다수우선, minority=소수/약자보호
...
var RESULT_TYPES = {
  'majority_rule': {
    ...
    axisLabel: { majority: '다수 우선', rule: '원칙 준수' },
    article: {
  ...
  'majority_situation': {
    ...
    axisLabel: { majority: '다수 우선', rule: '상황 판단' },
    article: {
  ...
  'minority_rule': {
    ...
    axisLabel: { majority: '소수/약자 보호', rule: '원칙 준수' },
    article: {
  ...
  'minority_situation': {
    ...
    axisLabel: { majority: '소수/약자 보호', rule: '상황 판단' },
    article: {
